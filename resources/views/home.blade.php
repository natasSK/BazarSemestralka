    ...
    <div class="container pt-1 px-4 kategorie" style="height: 400px">
        <div class="row my-3" style="height: 20%">
            <div class="col mx-2 " style="max-height: 100%">
                ...
                <a id="K_oblecenie" href="{{ route('search') }}?category=Oblečenie" class="card text-center mb-3" style="max-height: 100%">
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_auta" href="{{ route('search') }}?category=Autá" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_dom" href="{{ route('search') }}?category=Reality" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_deti" href="{{ route('search') }}?category=Deti" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
        ...
        <div class="row my-3" style="height: 20%">
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_motorka" href="{{ route('search') }}?category=Motorky" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_pohovka" href="{{ route('search') }}?category=Nábytok" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_pes" href="{{ route('search') }}?category=Zvieratá" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_naradie" href="{{ route('search') }}?category=Náradie" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
        ...
        <div class="row my-3" style="height: 20%">
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_lopta" href="{{ route('search') }}?category=Šport" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_hudba" href="{{ route('search') }}?category=Hudba" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_pc" href="{{ route('search') }}?category=PC" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_knihy" href="{{ route('search') }}?category=Knihy" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
        ...
        <div class="row my-3" style="height: 20%">
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_mobily" href="{{ route('search') }}?category=Mobily" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_fotak" href="{{ route('search') }}?category=Fotoaparáty" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_sluzby" href="{{ route('search') }}?category=Služby" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
            ...
            <div class="col mx-2" style="max-height: 100%">
                ...
                <a id="K_ostatne" href="{{ route('search') }}?category=Ostatné" class="card text-center mb-3" style="max-height: 100%">
                    <div class="card-body pt-2 pb-2 px-1">
                        <br><br>
                    </div>
                </a>
