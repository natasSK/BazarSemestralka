    ...
    <div class="container">
        ...
        <form action="/a" enctype="multipart/form-data" method="post">
            ...
            <div class="row my-3">
                ...
                <div class="col-md-6">
                    <select id="place" class="form-control @error('place') is-invalid @enderror" name="place" autocomplete="place">
            ...
            <div class="row my-3">
                ...
                <div class="col-md-6">
                    <select id="category" class="form-control @error('category') is-invalid @enderror" name="category" autocomplete="category">
            ...
            <div class="row my-3">
                ...
                <div class="col-md-6">
                    <select id="type" class="form-control @error('type') is-invalid @enderror" name="type" autocomplete="type">
